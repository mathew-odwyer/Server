...
public sealed class ValidationException : Exception
{
    ...
    /// Initializes a new instance of the <see cref="ValidationException"/> class.
    /// </summary>
    /// <param name="errors">The errors that describe the reason for the <see cref="ValidationException"/>.</param>
    ...
    /// </summary>
    /// <value>The errors that describe the reason for the <see cref="ValidationException"/>.</value>

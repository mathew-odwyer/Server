...
namespace Winterhaven.Infrastructure.Interceptors;
...
public sealed class AuditableEntitySaveChangesInterceptor : SaveChangesInterceptor
{
    ...
    private static void UpdateEntities(DbContext? context)
    {
        ...
        // Try to resolve IUserAccountContext from the current scope.
        var userAccountContext = context.GetService<IUserAccountContext>();
        var identifier = userAccountContext?.User?.Id ?? Guid.Empty;

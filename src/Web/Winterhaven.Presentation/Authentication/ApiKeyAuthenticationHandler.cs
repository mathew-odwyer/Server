namespace Winterhaven.Presentation.Authentication;
...
internal sealed class ApiKeyAuthenticationHandler : AuthenticationHandler<AuthenticationSchemeOptions>
{
    ...
    protected override Task<AuthenticateResult> HandleAuthenticateAsync()
    {
        ...
        // From here, if the server attempts to make a call to a Mediatr request handler on behalf of a user that is [Authorize] it will fail
        // However, this will give the server authority to make requests for things like fetching maps, NPC data, etc.

...
internal sealed class JwtOptions
{
    ...
    /// </summary>
    /// <value>The <see cref="string"/> that represents the intended audience for the JWT.</value>
    [Required]
    ...
    /// </summary>
    /// <value>The <see cref="string"/> that represents the issuer of the JWT.</value>
    [Required]
    ...
    /// </summary>
    /// <value>
    /// <c>true</c> if the JWT issuer signing key should be validated during token validation;
    /// otherwise, <c>false</c>.
    /// </value>
    [Required]

...
public class UserSessionToken : AuditableEntityBase
{
    ...
    /// </summary>
    /// <value>A <see cref="DateTime"/> that represents when the session will expire.</value>
    public DateTime AccessTokenExpirationDate { get; set; }

    /// <summary>
    /// Gets or sets a <see cref="DateTime"/> that represents when the refresh token used to refresh
    /// the session will expire.
    /// </summary>
    /// <value>
    /// A <see cref="DateTime"/> that represents when the refresh token used to refresh the session
    /// will expire.
    /// </value>
    ...
    /// </summary>
    /// <value>A <see cref="string"/> that represents the hashed refresh token.</value>
    public required string HashedRefreshToken { get; init; }

    /// <summary>
    /// Gets a value indicating whether this session is revoked.
    /// </summary>
    /// <value><c>true</c> if this session is revoked; otherwise, <c>false</c>.</value>
    public bool IsRevoked { get; set; }

    /// <summary>
    /// Gets the user account associated with this session.
    /// </summary>
    /// <value>The user account associated with this session.</value>

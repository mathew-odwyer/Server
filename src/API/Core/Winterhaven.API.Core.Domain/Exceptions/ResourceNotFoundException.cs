...
public sealed class ResourceNotFoundException : Exception
{
    ...
    /// <summary>
    ///   Initializes a new instance of the <see cref="ResourceNotFoundException"/> class with a specified entity name and key.
    /// </summary>
    /// <param name="name">
    ...
    /// </summary>
    /// <value>
    ///   The key (usually an identifier) of the resource that was not found
    /// </value>

...
/// </summary>
/// <typeparam name="TEntity">Specifies the type of the entity for the repository.</typeparam>
    ...
    where TEntity : EntityBase
{
    ...
    /// <param name="cancellationToken"></param>
    /// <returns>
    /// Returns a <see cref="Task{TEntity}"/> that represents the asynchronous operation. The task
    /// result contains the entity with the specified identifier, or null if no such entity exists.
    /// </returns>

...
{
    /// <summary>
    /// Gets the currently active session for the user account that matches the
    /// specified <paramref name="userAccountId"/>.
    /// </summary>
    /// <param name="userAccountId">
    /// The user account identifier of the user account to fetch the active session for.
    /// </param>
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>
    /// Returns the currently active session for the user account that matches the

...
<tileset version="1.10" tiledversion="1.11.0" name="ts_fireplace" tilewidth="16" tileheight="20" tilecount="12" columns="3">
 <image source="ts_fireplace.png" width="48" height="80"/>
 <tile id="0">
  <animation>
